...
public:
	...
	int aaaaGzPutTriangle(int numParts, GzToken *nameList, GzPointer *valueList);
	// HW3
	int GzDefaultCamera();
	...
	void sortOnV2(GzCoord V1, GzCoord V2, GzCoord V3,
		GzCoord N1, GzCoord N2, GzCoord N3,
		GzTextureIndex UV1, GzTextureIndex UV2, GzTextureIndex UV);

	void flatShader(GzCoord faceNormal);
		
	void gouraudShader(int i, int j, GzCoord V1, GzCoord V2, GzCoord V3,
		GzCoord N1, GzCoord N2, GzCoord N3,
